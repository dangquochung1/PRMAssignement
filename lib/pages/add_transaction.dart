...
class _AddTransactionState extends State<AddTransaction> {
  ...
  _loadData() async {
    ...
    if (userId != null) {
      try {
        ...
        List<Map<String, dynamic>> txList = await DatabaseMethdos()
  ...
  void _showWalletPicker() {
    List<Map<String, dynamic>> paymentWallets = wallets
        .where((w) => w["type"] != "Tracking")
        .toList();
    List<Map<String, dynamic>> trackingWallets = wallets
        .where((w) => w["type"] == "Tracking")
        .toList();
                          ...
                          return Column(
                            ...
                            children: [
                              ...
                              ...cats.map((cat) {
                                ...
                                double allocated = (cat["allocated"] ?? 0)
                                    .toDouble();
                                double spent =
        ...
        return StatefulBuilder(
          builder: (ctx2, setSheet) {
            List<String> filtered = labels
                .where(
                  (l) => l.toLowerCase().contains(searchText.toLowerCase()),
                )
                .toList();
            return DraggableScrollableSheet(
              initialChildSize: 0.6,
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      TextField(
                        ...
                        onChanged: (v) => setSheet(() => searchText = v),
                      ),
                      const SizedBox(height: 12),
                      Expanded(
                        child: ListView.builder(
                          ...
                          itemBuilder: (_, i) {
                            ...
                            return GestureDetector(
                              onTap: () {
                                setState(() => selectedLabel = filtered[i]);
                                Navigator.pop(ctx);
                              },
                              child: Container(
                                padding: const EdgeInsets.symmetric(
  ...
  Future<void> _handleSaveAndContinue() async {
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      const SnackBar(
        ...
        content: Text("Đã lưu! Tiếp tục nhập giao dịch mới"),
      ),
    );
  }
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Builder(
                            builder: (context) {
                              double allocated =
                                  allocatedByCategory[selectedCategory] ?? 0;
                              double spent =
                    ...
                    Expanded(
                      ...
                      child: GridView.builder(
                        ...
                        itemBuilder: (_, index) {
                          ...
                          return _numButton(key);
                        },
                      ),
                    ),
                    const SizedBox(width: 4),
                    // Cột phải: 3 nút thao tác
                    Expanded(
                      child: Column(
                        children: [
                          Expanded(
